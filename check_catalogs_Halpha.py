...
#df_background_dropped = df_background_dropped[(df_background_dropped['OType'] == "YSOc") | (df_background_dropped['OType'] == "YSOc_PAH-em") | (df_background_dropped['OType'] == "YSOc_red") | (df_background_dropped['OType'] == "YSOc_star+dust")]
...
plt.figure(dpi = 150)
plt.grid()
plt.scatter(background_Ha_contsub_mag,background_Ha_contsub_mag - background_r_mag,color='xkcd:red',marker=".")
plt.plot(np.arange(-50,50,1),np.full(100,0),color='xkcd:black')
#plt.plot(np.arange(-50,50,1),np.arange(-50,50,1),color='xkcd:black')
plt.xlabel('H-alpha mag (cs)', size = 10)
plt.ylabel('H-alpha mag (cs) minus r mag', size = 10)
#plt.ylabel('r mag', size = 10)
plt.xlim(10,25)
#plt.ylim(10,25)
