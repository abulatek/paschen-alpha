# Written by Adam Ginsburg, adapted by Alyssa Bulatek to remove dependence on PyLab
# Original: https://github.com/keflavich/mpl_plot_templates/blob/master/mpl_plot_templates/adaptive_param_plot.py
